...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (btnConfirmarPago) {
        btnConfirmarPago.addEventListener("click", () => {
            // Confirmación simulada de compra (sin pasarela de pago real,
            // según lo definido en la ERS del proyecto).
            alert("🎉 ¡Compra realizada con éxito! Su pedido industrial ha sido registrado y será enviado a obra.");
